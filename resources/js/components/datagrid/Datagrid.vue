    ...
    <div class="bg-datagrid rounded-xl border border-sidebar-border/70 md:min-h-min dark:border-sidebar-border">
        <div role="table" class="w-full">
            <div class="flex items-center border-b p-4 text-left text-sm font-semibold">
                ...
                <div class="flex gap-2">
                    ...
                    <Filter
                        ...
                        :fields="[
                            { name: 'first_name', label: 'Primeiro Nome', type: 'string' },
            ...
            <div v-if="loading" class="p-4">
                <Skeleton data-testid="skeleton" class="mb-4 h-4 max-w-(--skeleton-width) flex-1" :style="{ '--skeleton-width': 100 }" />
                <Skeleton class="mb-4 h-4 max-w-(--skeleton-width) flex-1" :style="{ '--skeleton-width': 100 }" />
            ...
            <div v-else>
                <div v-if="!data.items.length" class="mt-4 flex min-h-[450px] flex-1 flex-col items-center justify-center space-y-8">
                    ...
                    <span class="mt-3 text-sm font-semibold text-neutral-500">No items found.</span>
                    <Button><a href="https://curotec-assessment.test/docs" title="Documentation">Go to documentation</a></Button>
                </div>
